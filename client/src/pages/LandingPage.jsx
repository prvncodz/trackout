...
const Features = () => {
  return (
    <section id="features" className="selection:bg-near-black selection:text-btn-color my-15 w-full lg:my-35 lg:h-200">
  ...
  return (
    <footer className="border-line-color mt-40 flex w-full flex-col items-center justify-center border-t py-5 md:mt-70">
      <h2 className="w-full max-w-[95%] text-center font-serif text-base text-gray-700 md:max-w-[80%] md:text-xl">
        "It removes emotion from the process. You are left only with the architecture of your own discipline and the

...
const Layout = ({ children }) => {
  return (
    <div className="relative mx-auto w-full overflow-hidden lg:max-w-[60vw]">
      {children}
    </div>
  );
};
...
const WorkflowCard = ({ no, title, description }) => {
  return (
    <div className="flex-start my-4 flex w-auto items-center justify-center px-8 text-center md:flex-col">
      <div className="text-near-black flex h-15 w-15 items-center justify-center rounded-full bg-gray-200 p-2 font-serif font-bold">
        {no}
      </div>
...
const LandingPage = () => {
  const navigate = useNavigate();
  return (
    <div className="selection:bg-near-black selection:text-btn-text relative flex w-full max-w-screen flex-col items-center justify-center bg-neutral-50">
      <Navbar>

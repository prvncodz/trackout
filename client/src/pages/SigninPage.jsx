    ...
    return (
        <div className="mx-auto w-full max-w-lg tracking-normal">
            ...
            <Button
                onClick={onSubmit}
                disabled={loading}
                className="mt-14 h-14 w-full text-lg"
            >
                {loading ? (
...
const Backbtn = () => {
    ...
    return (
        <motion.button
            className="border-line-color absolute top-5 left-5 rounded-full border bg-gray-50 p-4 text-gray-700 hover:bg-neutral-50 hover:text-gray-800 cursor-pointer"
            onClick={() => navigate("/")}
            initial={{
                opacity: 0,
                scale: 0.9,

...
const CalenderComponent = ({ className = "", size = "md", ...props }) => {
    ...
    return (
        <div
            className={`flex shrink-0 flex-col items-start justify-center gap-4 rounded-2xl  overflow-hidden p-5 size-auto shadow-standard  ${className}`}
            {...props}
        >
            {/* <h2 */}
            ...
            <div className="flex h-auto w-full items-center justify-center">
                <Calendar
                    ...
                    className={` flex w-full rounded-lg bg-none ${className}`}
                    modifiers={{
                        active: ActiveDates,
                    }}
                    size={size}

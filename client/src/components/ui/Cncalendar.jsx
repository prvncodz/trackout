...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn(
                `group/calendar bg-background flex flex-col items-center justify-center p-3 [--cell-radius:var(--radius-md)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent`,
                sizeMap[size],
            ...
            classNames={{
                ...
                disabled: cn(defaultClassNames.disabled, "text-green-900"),
            ...
            components={{
                ...
                DayButton: ({ ...props }) => <CalendarDayButton locale={locale} size={size} {...props} />,
...
function CalendarDayButton({ className, day, size, modifiers, locale, ...props }) {
    const defaultClassNames = getDefaultClassNames()
    ...
    return (
        <Button
            ...
            className={cn(
                ...
                `disabled:opacity-70 disabled:after:absolute disabled:after:content-['✓'] ${size === "lg" ? "disabled:after:bottom-0 lg:disabled:after:bottom-0.5" : size === "md" ? "disabled:after:-bottom-0.5 disabled:after:text-xs lg:disabled:after:bottom-px" : " disabled:after:text-2xs disabled:after:-bottom-0.5 lg:disabled:after:bottom-px"}`,
                `antialiased`,
                defaultClassNames.day,
                className,
            )}
